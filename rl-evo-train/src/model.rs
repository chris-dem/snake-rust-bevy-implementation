...
use burn::{
    nn::{
        ...
        PaddingConfig2d, Relu, activation,
...
impl ModelConfig {
    pub fn init<B: Backend>(&self, device: &B::Device) -> Model<B> {
        Model {
            conv1: Conv2dConfig::new([4, 8], [3, 3])
...
#[derive(Debug, Clone)]
pub struct StateRepr<B: Backend>(pub Tensor<B, 4>); // B R H [empty, snake head, snake body, food]
